        ...
        <div class="col-md-12" style="margin-top: 5%">
          ...
          <div class="box box-info">
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h3 class="box-title" style="font-size: 40px;">THÊM KHOA</h3>
            </div>
            <!-- /.box-header -->
            ...
            <!-- form start -->
            <form class="form-horizontal" method="post" name="form_them_khoa" action="controller/them_khoa.php">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-info pull-right" onclick="testThemKhoa()">Thêm</button>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
