					  ...
					  if($sodong3>0){
  				 	while($kq3 = mysqli_fetch_array($query3)){
				    	 ...
				    	 ";
					  	...
					  	echo "</td>
					        <td ><a href=\"?khoatrang=gv_ds_nhomhocphan_ct&txttenmon=$tenmon&hocky=$hk&mamon=$kq[MA_MH]&mahp=$kq[ID_NHOM_HP]\"><img src=\"icon/xem.png\" style=\"width: 15px; height: 15px;\"/></a></td>
							</tr>";
					  	} //if so dong3
				 else {
					 echo "
  				...
  				if($sodong>0){
  				 while($kq = mysqli_fetch_array($query)){
				     ...
				     ";
					  ...
					  echo "</td>
					         <td ><a href=\"?khoatrang=gv_ds_nhomhocphan_ct&namhoc=$namhoc&hocky=$hk&mamon=$kq[MA_MH]&mahp=$kq[ID_NHOM_HP]\"><img src=\"icon/xem.png\" style=\"width: 15px; height: 15px;\"/></a></td>
							 </tr>";
					  } //if so dong3
				 else {
					 echo "
				 ...
				 if($sodong>0){
  				 while($kq = mysqli_fetch_array($query)){
				     ...
				     ";
					  ...
					  echo "</td>
					         <td ><a href=\"?khoatrang=gv_ds_nhomhocphan_ct&txttenmon=$tenmon&mamon=$kq[MA_MH]&mahp=$kq[ID_NHOM_HP]\"><img src=\"icon/xem.png\" style=\"width: 15px; height: 15px;\"/></a></td>
							 </tr>";
					  } //if so dong3
				 else {
					 echo "
