...
<?php include_once('widgets/header.php'); ?>
 ...
 <!DOCTYPE html>
   ...
   <body>
    <div class="container">
<center><h1>Thêm thành viên</h1></center>
...
<form  id="main-form" method="post" class="form-horizontal" action="<?php echo create_link(base_url('admin/index.php'), array('m' => 'user', 'a' => 'add')); ?>">
    ...
    <table cellspacing="0" cellpadding="0" class="form">
        ...
        <tr>
            <th><sup style="color: red">(*)</sup>Mật khẩu</th>
            <td>
        ...
        <tr>
            <th><sup style="color: red">(*)</sup>Nhập lại mật khẩu</th>
            <td>
        ...
        <tr>
            ...
            <td>
                <select name="ID_UG"  class="form-control" >
                    <option value="">-- Chọn User Group --</option>
        ...
        <tr>
            ...
            <td>
                <select name="ID_WP"  class="form-control" >
                    ...
                    <option value="BD" 	<?php echo (input_post('ID_WP') == 'BD') 	? 'selected' : ''; ?>>Khoa DBDT</option>
...
<div class="controls">
    <a class="btn btn-primary btn-sm" role="button" onclick="$('#main-form').submit()" href="#">Thêm</a>
