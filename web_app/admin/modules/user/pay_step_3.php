...
<center><form id="main-form" method="POST">
    ...
    <table cellspacing="0" cellpadding="0" class="form">
        <tr>
            ...
            <td>
                <input type="text" name="id_pay_member" class="form-control" placeholder="ID Card of Member" value="<?php echo input_post('id_member'); ?>" />
...
<div class="controls">
    ...
    <button id="commit" class="btn btn-primary btn-sm">OK</button>
...
$(document).ready(function(){
  $("#commit").click(function(){
    ...
    $.ajax({
      type: "post",
      url: "<?=create_link(base_url('admin'), array('m' => 'user', 'a' => 'pay_processing'));?>",
      cache: false,
