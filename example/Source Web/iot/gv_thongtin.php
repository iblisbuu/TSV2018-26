<?php
  ...
  $sql= "SELECT * FROM bo_mon, giao_vien, khoa
  				  WHERE
  						giao_vien.TAIKHOAN_USER= '$user' AND
						giao_vien.ID_BO_MON=bo_mon.ID_BO_MON AND
						khoa.ID_KHOA=bo_mon.ID_KHOA
						";
  $query = mysqli_query($conn,$sql);
  while($kq = mysqli_fetch_array($query)){
	  $ma_gv    = $kq['TAIKHOAN_USER'];
	  $gioi_tinh= $kq['GIOI_TINH'];
	  $bo_mon   = $kq['TEN_BO_MON'];
        ...
        <div class="col-md-12" style="margin-top: 5%">
          ...
          <div class="box box-info">
            <div class="box-header with-border" style="text-align: center;">
              <h3 class="box-title" style="font-size: 40px;">THÔNG TIN GIẢNG VIÊN</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post">
             ...
             <img  width="290px" height="300px" src="dist/img/<?php echo $hinh; ?>">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="txttaikhoan" class="col-sm-2 control-label">Mã cán bộ</label>
                ...
                <div class="form-group">
                 ...
                 <div class="col-sm-10">
                  ...
                  <div class="form-group">
                  <label for="txtbomon" class="col-sm-2 control-label">Bộ môn</label>

                 <div class="col-sm-10">
					  <div class="form-control" style="border: none;font-size: 20px;"><?php echo $bo_mon; ?></div>
                  </div>
                </div>
              ...
              <div class="box-footer" style="text-align: left; margin-left: 7%;">
               <a href="?khoatrang=gv_lichday"> <button type="button" class="btn btn-default">Trở lại</button></a>
               <a href="?khoatrang=gv_doimatkhau"> <button type="button" class="btn btn-default">Đổi mật khẩu</button></a>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
