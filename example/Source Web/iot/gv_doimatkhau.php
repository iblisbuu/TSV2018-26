...
$sql1="UPDATE user, giao_vien SET user.PASSWORD_USER = '$mahoa_new', giao_vien.PASSWORD_USER = '$mahoa_new'
                                WHERE user.TAIKHOAN_USER='$user' AND giao_vien.TAIKHOAN_USER='$user'";
//echo $sql1;
$query1= mysqli_query($conn,$sql1);
if(mysqli_affected_rows($conn)>0){
	echo "<script> alert ('Đổi mật khẩu thành công!'); window.location='gv_index.php?khoatrang=gv_thongtin'; </script>";
}
else{
          ...
          <div class="box">
            ...
            <form class="form-horizontal" method="post" action="#" onSubmit="return ktra(matkhaucu.value , matkhaumoi.value, xacnhan.value);">
              ...
              <div class="box-footer" style="text-align: center">
                ...
                <a href="?khoatrang=gv_thongtin" class="btn btn-info pull-center">Hủy</a>
