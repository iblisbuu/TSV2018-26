    ...
    <!--     <a class="navbar-brand" href="#">Brand</a> -->
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul  class="nav navbar-nav">
          <li><a   role="button" href="<?php echo create_link(base_url('admin'), array('m' => 'user', 'a' => 'list')); ?>"> User <span class="sr-only">(current)</span></a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          <div style="padding-top: 15px">
                      Xin chào <span style="font-weight: bold"> <?php echo get_current_name(); ?> </span>|
