...
<div class="container">
<center><h1>Danh sách thành viên</h1></center>
        <div class="controls">
        ...
        <br>
            <div class="controls">
    <a class="btn btn-primary btn-sm" role="button" style=" " href="<?php echo create_link(base_url('admin'), array('m' => 'user', 'a' => 'add')); ?>">Thêm</a>
</div>
